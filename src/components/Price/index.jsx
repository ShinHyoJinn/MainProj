      ...
      <div className="Price-info-section">
        ...
        <div className="Price-price-row">
          <div className="Price-dog-type">
            <img src="/placeholder.svg" alt="소형견" className="Price-dog-icon" width={24} height={24} />
            <span>소형견</span>
        ...
        <div className="Price-price-row">
          <div className="Price-dog-type">
            <img src="/placeholder.svg" alt="대형견" className="Price-dog-icon" width={24} height={24} />
            <span>대형견</span>
        ...
        <div className="Price-additional-service">
          ...
          <div className="Price-service-row">
            <div className="Price-service-info">
              <img src="/placeholder.svg" alt="시간" className="Price-clock-icon" width={24} height={24} />
              <span>시간 연장(30분)</span>
            </div>
